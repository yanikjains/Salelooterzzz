...
const INSTAGRAM_URL = "https://www.instagram.com/salelooterz";
    ...
    <motion.header initial={{ y: -20, opacity: 0 }} animate={{ y: 0, opacity: 1 }}
      ...
      <div className="hidden md:flex items-center gap-3">
        ...
        <a href={LINKEDIN_URL} target="_blank" rel="noopener noreferrer" aria-label="SaleLooterz on LinkedIn"
          className="flex items-center justify-center w-10 h-10 rounded-full transition-all hover:opacity-90"
          style={{ background: "#0A66C2", color: "#fff" }}>
          <LinkedInIcon size={17} />
        </a>
        <a href={INSTAGRAM_URL} target="_blank" rel="noopener noreferrer" aria-label="SaleLooterz on Instagram"
          className="flex items-center justify-center w-10 h-10 rounded-full transition-all hover:opacity-90"
          style={{ background: "radial-gradient(circle at 30% 110%, #f09433 0%, #e6683c 25%, #dc2743 50%, #cc2366 75%, #bc1888 100%)", color: "#fff" }}>
...
const STEPS = [
  ...
  { n: "03", title: "Tap & buy",              body: "One tap takes you straight to the deal. No searching, no hunting.",      color: GREEN  },
];
